...
def order_pay(order_id):
    ...
    alipay_client = AliPay(
        ...
        alipay_public_key_path=os.path.join(os.path.dirname(__file__), "keys/alipay_public_key.pem"),  # 支付宝的公钥
    ...
    order_string = alipay_client.api_alipay_trade_wap_pay(
        ...
        notify_url=None  # 可选, (此项作用是支付宝后台访问我们的连接，告诉后台支付结果，但是我啊，没有公网ip，嘿嘿)
    )
